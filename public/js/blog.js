...
Foaf.createName = React.createFactory(Foaf.Name);
...
var createTimestamp = React.createFactory(Timestamp);
...
var BlogApp = function (baseIri, blogIri) {
  ...
  var createHeader = React.createFactory(Header);
  ...
  var createPosts = React.createFactory(Posts);
  ...
  var createPostForm = React.createFactory(PostForm);
      ...
      post =
        React.DOM.div({className: 'blog-post'},
          ...
          React.DOM.small(null,
            createTimestamp({date: this.props.datePublished}),
            ' by ',
            Foaf.createName({iri: this.props.author['@id']})
          )
        );
  ...
  var createPost = React.createFactory(Post);
  ...
  var Comment = React.createClass({
    ...
    render: function () {
      return React.DOM.blockquote(
        ...
        React.DOM.small(null,
          createTimestamp({date: this.props.commentTime}),
          ' by ',
          Foaf.createName({iri: this.props.creator['@id']}))
      );
    }
  });

  var createComment = React.createFactory(Comment);
  ...
  var createCommentForm = React.createFactory(CommentForm);
  ...
  jsonify.get(blogIri, {'@vocab': 'http://schema.org/'}).then(function (blog) {
    React.render(createHeader(blog), document.getElementById('blog-header'));
    React.render(createPosts(blog), document.getElementById('blog-posts'));
